...
class WeeklyWeatherForecast {
    ...
    class func downloadWeeklyWeatherForecast(location: WeatherLocation, completion: @escaping (_ weatherForecast: [WeeklyWeatherForecast]) -> Void) {
        ...
        if !location.isCurrentLocation {
            ...
            WEEKLYFORECAST_URL = String(format: "https://api.weatherbit.io/v2.0/forecast/daily?city=%@,%@&days=7&key=f3da95f3913d4b8c9f45ba4eea5e3225", location.city, location.countryCode)
        } else {
